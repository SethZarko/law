...
export default {
  ...
  methods: {
    handleSubmit() {
      console.log('Message Sent Nowhere!', this.name, this.email, this.phone, this.find, this.message);
      this.name = '';
      this.email = '';
      this.phone = '';
      this.find = '';
    ...
    <section id="cs-contact-242">
      <div class="cs-container">
        <div class="cs-content">
          <span class="cs-topper">Let's Talk</span>
        ...
        <!-- Form -->
        <form id="cs-form-242" @submit.prevent="handleSubmit">
        ...
        <div class="cs-right-section">
          <ul class="cs-ul">
            ...
            <li class="cs-li">
              ...
              <div class="cs-flex-group">
                ...
                <a class="cs-link">519-555-5544</a>
              </div>
            </li>
            <li class="cs-li">
              <picture class="cs-icon-wrapper">
              ...
              <div class="cs-flex-group">
                ...
                <a class="cs-link"
                  ><span class="cs-block">1587 Rockwell Street
                    </span> Toronto, ON M5F 4D5</a
                >
              </div>
            </li>
          </ul>
          ...
          <picture class="cs-picture">
            <source
              ...
              srcset="
                https://csimg.nyc3.digitaloceanspaces.com/Contact-Page/map-m.jpg
              "
            />
            <source
              media="(min-width: 601px)"
              srcset="
                https://csimg.nyc3.digitaloceanspaces.com/Contact-Page/map.jpg
              "
            />
            <!-- <img
              class="cs-img"
              ...
              height="438"
            /> -->
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d13459.661809347399!2d-73.96347299038044!3d40.77049983607472!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c258f3ae5c307b%3A0x8837aff801306c08!2sSheep%20Meadow!5e0!3m2!1sen!2sca!4v1732805783355!5m2!1sen!2sca" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
          </picture>
        </div>
      </div>
    </section>
