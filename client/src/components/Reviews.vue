...
export default {
  data() {
    return {
      testimonials: [
        {
          image: "https://csimg.nyc3.cdn.digitaloceanspaces.com/Images/People/review1.png",
          text: "Haec optima lex firma semper fuit! Fecerunt clausulam emendo domum meam tam facilem ac liberam lacus! utinam tractet!",
          name: "Martin Darby",
          description: "Real Estate Closing"
        },
        {
          image: "https://csimg.nyc3.cdn.digitaloceanspaces.com/Images/People/review2.png",
          text: "Nulla ultricies justo sit amet ante efficitur, eget pharetra augue efficitur. Vestibulum viverra, dolor sit amet ultricies.",
          name: "Brian Grilcist",
          description: "Incorporation Process"
        },
        {
          image: "https://csimg.nyc3.cdn.digitaloceanspaces.com/Images/People/reviews3.png",
          text: "Nulla ultricies justo sit amet ante efficitur, eget pharetra augue efficitur. Vestibulum viverra, dolor sit amet ultricies.",
          name: "Bruce Elowed",
          description: "Drafting Family Wills"
        }
      ]
    }
  }
  ...
  <section id="reviews-1088">
    <div class="cs-container">
      <div class="cs-content">
        ...
        <h2 class="cs-title">What Our Clients Have to Say About Us</h2>
      </div>
      <ul class="cs-card-group">
        <li v-for="(testimonial, index) in testimonials" :key="index" class="cs-item">
          <img 
            class="cs-image" 
          ...
          <div class="cs-flex">
            ...
            <span class="cs-desc">{{ testimonial.description }}</span>
          </div>
        </li>
      </ul>
    </div>
