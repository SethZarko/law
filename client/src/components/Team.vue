      ...
      teamMembers: [
        {
          name: "Rocko Delgatto",
          job: "Owner/Founder",
          imageSrc: new URL('../assets/user.png', import.meta.url).href,
        },
        {
          name: "Marc Atony",
          job: "Partner",
    ...
    <div class="cs-container">
      <div class="cs-content">
        <img
          ...
          loading="lazy"
          decoding="async"
          src="https://csimg.nyc3.cdn.digitaloceanspaces.com/Icons/Ornament.svg"
          alt="chef"
          width="456"
          height="31"
        />
        ...
        <p class="cs-text">
          Expert and trusted lawyers with over 30 years of combined experience. 
        </p>
      </div>
      <ul class="cs-card-group">
        <li v-for="(member, index) in teamMembers" :key="index" class="cs-item">
