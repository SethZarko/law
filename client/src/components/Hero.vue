  ...
  <section id="hero-1619">
    <div class="cs-container">
      <div class="cs-content">
        ...
        <h1 class="cs-title">
          Trusted Lawyers Serving Clients Across Ontario
        </h1>
        <span class="established">Since 1987</span>
        <router-link to="/contact" class="cs-button-solid" @click="this.scrollToTop()">Request Appointment</router-link>
      </div>
      <ul class="cs-card-group">
        <li class="cs-item">
          <img
            ...
            height="48"
          />
          <h3 class="cs-h3">98% Success Rate</h3>
          <p class="cs-item-text">
            We provide some of the finest quality, most responsive and reliable,
            and cost effective legal services and solutions.
          </p>
        </li>
        <li class="cs-item">
          <img
          ...
          <p class="cs-item-text">
            We provide some of the finest quality, most responsive and reliable,
            and cost effective services and solutions.
          </p>
        </li>
        <li class="cs-item">
          <img
        ...
        <li class="cs-item">
          <img
            ...
            height="48"
          />
          <h3 class="cs-h3">Trusted Everywhere</h3>
          <p class="cs-item-text">
            We provide some of the finest quality, most responsive and reliable,
            and cost effective services and solutions.
          </p>
    ...
    <picture class="cs-background">
      <source
        ...
        srcset="
          https://csimg.nyc3.cdn.digitaloceanspaces.com/Images/People/meeting7-m.jpeg
        "
      />
      <source
...
@media only screen and (min-width: 0rem) {
  ...
  .established {
    color: white;
    margin: -1.75rem 0 2rem 0 !important;
  }
}
/* Tablet - 768px */
